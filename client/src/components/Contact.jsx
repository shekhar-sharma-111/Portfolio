...
//       if (response.ok) {
//         setSubmitStatus('Message sent successfully! Please avoid sending unnecessary messages.');
//       } else {
//         const errorData = await response.json();
//         setSubmitStatus(`Failed to send message: ${errorData.error || 'Unknown error'}`);
//       }
//     } catch (error) {
//       setSubmitStatus(`Error sending message: ${error.message}`);
//     }
//   };
...
//         <button
//           type="submit"
//           className="w-full py-2.5 px-4 rounded-md bg-indigo-600 text-white font-semibold shadow-sm hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
//         >
//           Send Message
//         </button>
//         {submitStatus && <p className="mt-4 text-center">{submitStatus}</p>}
